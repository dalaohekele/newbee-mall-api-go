...
type MallIndexConfigService struct {
}
...
// 首页返回相关IndexConfig
func (m *MallIndexConfigService) GetConfigGoodsForIndex(configType int, num int) (err error, list interface{}) {
	...
	var indexGoodsList []manageRes.MallIndexConfigGoodsResponse
	// 超出30个字符显示....
	for _, indexGoods := range goodsList {
		res := manageRes.MallIndexConfigGoodsResponse{
